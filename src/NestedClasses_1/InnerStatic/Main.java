package NestedClasses_1.InnerStatic;

import NestedClasses_1.InnerStatic.model.EquilateralShape;
...
public class Main {
    ...
    static class EquilateralTriangle implements EquilateralShape {
